...
def get_activities(
    ...
    - difficulty: Filter by difficulty level (e.g., 'Beginner', 'Intermediate', 'Advanced', or 'All' for activities without difficulty)
    """
    ...
    if difficulty:
        if difficulty == "All":
            # "All" means activities with no difficulty field
